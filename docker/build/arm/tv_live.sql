...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`tv_live` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `users`(`id`,`username`,`password`,`created_at`,`updated_at`) values (1,'admin','ZTEwYWRjMzk0OWJhNTlhYmJlNTZlMDU3ZjIwZjg4M2U=',1624527803,1624527803);
